import type { BlockDef, Categoria } from "./types.js";
...
function b(id: string, icone: string, nome: string, desc: string): BlockDef {
...
const INDEX = new Map<string, ResolvedDef>();
...
export function resolveDef(id: string): ResolvedDef | undefined {
  return INDEX.get(id);
}
