...
export interface ResolvedTheme {
  ...
  categories: Readonly<Record<CategoryKey, CategoryColors>>;
}

const CATEGORY_INK_LIGHT = "#1F1E1B";
const CATEGORY_INK_DARK = "#ECEAE4";

export const LIGHT_THEME: ResolvedTheme = Object.freeze({
  name: "light",
  canvas: "#FBFAF8",
  surface: "#FFFFFF",
  surface2: "#F4F3EF",
...
export const DARK_THEME: ResolvedTheme = Object.freeze({
  name: "dark",
  canvas: "#201F1C",
  surface: "#2A2925",
  surface2: "#34322D",
...
export function parseThemePreference(value: string | null): ThemeName {
